...
import cn.nigel.boot.framework.tracer.core.aop.BizTraceAspect;
import cn.nigel.boot.framework.tracer.core.filter.TraceFilter;
...
@EnableConfigurationProperties(cn.nigel.boot.framework.tracer.config.TracerProperties.class)
@ConditionalOnProperty(prefix = "video.tracer", value = "enable", matchIfMissing = true)
public class VideoTracerAutoConfiguration {
